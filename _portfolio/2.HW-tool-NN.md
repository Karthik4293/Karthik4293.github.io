...
excerpt: "<i>a low-level software to build hardware design scripts for a neural network of varying port selection and parallelism.</i><br/><img width ='500' src='/images/neural_network.jpg'><br/><br/>`Neural Networks` ` C++ ` `Digital System design``System Verilog`"
