...
excerpt: "<i>A wrapper template that supports murmur3 hashing for all primitive data types.</i><br/><img width ='350' src='/images/Hashing1.gif'><br/><br/>`C++ 11` `Data Structures``Linux`"
